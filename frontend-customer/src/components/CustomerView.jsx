...
export default function CustomerView({ onLogout, onLoginRequest, dbMode, currentUser }) {
  ...
  const seoData = useMemo(() => {
    if (selectedItem) {
      return {
        title: `${selectedItem.name} | FoodPilot`,
        description: selectedItem.description || `Buy authentic ${selectedItem.name} online from FoodPilot.`
      };
    }
    switch (activeTab) {
      case "home":
        return { title: "FoodPilot | Authentic Indian Homemade Foods", description: "Order premium homemade Indian foods, pickles, sweets, and snacks online. Pan-India delivery available." };
      case "shop":
        return { title: "Shop Pickles & Sweets | FoodPilot", description: "Browse our authentic homemade pickles, sweets, spice powders, and snacks." };
      case "cart":
      case "checkout":
      case "checkout-flow":
        return { title: "Secure Checkout | FoodPilot", description: "Review and securely checkout your order at FoodPilot." };
      case "profile":
      case "orders":
      case "wishlist":
      case "tickets":
        return { title: "Your Profile | FoodPilot", description: "Manage your account, view your orders, and contact support." };
      case "terms":
        return { title: "Terms of Service | FoodPilot", description: "Read our terms of service and policies." };
      case "privacy":
        return { title: "Privacy Policy | FoodPilot", description: "Learn how we protect and process your data." };
      default:
        return { title: "FoodPilot | Authentic Indian Foods", description: "Premium homemade Indian foods delivered to your door." };
    }
